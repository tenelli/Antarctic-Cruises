...
var routes = document.querySelectorAll('.routes__article');
routes.forEach(function (article) {
  article.classList.remove('routes__article--no-js');
  article.addEventListener('click', function () {
    var temp = article.firstElementChild;
    var card = article.lastElementChild;
...
var burgerButton = document.querySelector('[data-open-button]');
...
var headerDescription = document.querySelector('[data-header-description]');
var header = document.querySelector('[data-page-header');
var headerMain = document.querySelector('[data-header-main]');
var headerNavigation = document.querySelector('[data-header-navigation');
var headerDarkLogo = document.querySelector('[data-dark-logo]');
...
var modalAnchor = document.querySelectorAll('[data-modal-wrapper]');
if (modal) {
...
function closeModal() {
  ...
  modalAnchor.forEach(function (anchor) {
...
function init() {
  ...
  var placemark = new ymaps.Placemark([59.937428, 30.322603], {}, {
...
var formEmail = document.querySelector('[data-email-input]');
var form = document.querySelector('[data-form]');
var isStorageSupport = true;
var userNameStorage = '';
var userPhoneStorage = '';
var userEmailStorage = '';
if (form) {
  try {
